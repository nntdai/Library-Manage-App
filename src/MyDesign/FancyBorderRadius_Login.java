 ...
 * @author Raven
 */
public class FancyBorderRadius_Login {
    ...
    public Border_Login getBorder() {
        return border;
    }

    public void setBorder(Border_Login border) {
        this.border = border;
    }

    public FancyBorderRadius_Login(double width, double height, Border_Login border) {
        this.width = width;
        this.height = height;
        this.border = new Border_Login();
        this.border = border;
    }

    public FancyBorderRadius_Login(double width, double height, String border) {
        this(width, height, new Border_Login(border));
    }

    public FancyBorderRadius_Login() {
    }

    private double width;
    private double height;
    private Border_Login border;
