...
public class StaffAdd_Dialog extends javax.swing.JDialog {
     ...
     */
    public StaffAdd_Dialog(java.awt.Frame parent, boolean modal,MyDesign.MyTable tab,int userID,String role) {
        super(parent, modal);
        try {
			sBLL=new staffBLL();
        ...
        initComponents(tab,userID,role);
        addRole(role);
    }
    ...
    public void addDefaultAD(MyDesign.MyTable tab) throws Exception{
        ...
        public void addNewRole() throws Exception {
        	...
        	while(!keyName) {
        		...
        		name=name.trim();
        		if(name.matches(nameReg) && name!="" && sBLL.addRoleName(name)) {
        			keyName=true;
        			break;
        		}
        	...
        	while(!keyID) {
        		...
        		id=id.trim();
        		if(id.matches(idReg) && id!="" && sBLL.addRoleNameID(id)) {
        			keyID=true;
        			break;
        		}
        		JOptionPane.showMessageDialog(null,"Mã vai trò mới không hợp lệ");
        	}
        	JOptionPane.showMessageDialog(null,sBLL.addBrandNewRole(name, id));
        }
    @SuppressWarnings("unchecked")
    // <editor-fold defaultstate="collapsed" desc="Generated Code">//GEN-BEGIN:initComponents
    private void initComponents(MyDesign.MyTable tab,int userID,String role) {
       		...
       		try {
       		    ...
       		    try {
					if(checkDataVal(name,tel,address,username,password)) {
						JOptionPane.showMessageDialog(null,sBLL.addStaff(new Staff(name,tel,address,username,password,userID,role)));
						addDefaultQL(tab);
						dispose();
					}
				} catch (Exception e1) {
        ...
        lbChucVu.addMouseListener(new MouseAdapter() {
            @Override
